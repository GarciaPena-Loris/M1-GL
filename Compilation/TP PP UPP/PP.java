...
class PPInv extends PPUnOp {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        ...
        UPPCte zero = new UPPCte(0);
        return new UPPSub(zero, ne);
    }// toUPP
...
class PPArrayGet extends PPExpr {
    ...
    UPPExpr toUPP(ArrayList<String> locals) {
        ...
        UPPExpr narray = new UPPAdd(narr, new UPPMul(nindex, new UPPCte(4)));

        return new UPPLoad(narray);
    }// toUPP
...
class PPArraySet extends PPInst {
    ...
    UPPInst toUPP(ArrayList<String> locals) {
        ...
        return new UPPStore(narray, nval);
    }// toUPP
...
class PPProc extends PPDef {
    ...
    UPPDef toUPP() {
        ...
        for (Pair<String, Type> e : args)
            sargs.add(e.left);
        ArrayList<String> slocals = new ArrayList<String>();
        for (Pair<String, Type> e : locals)
            slocals.add(e.left);
        UPPInst ncode = code.toUPP(slocals);

        return new UPPProc(name, sargs, slocals, ncode);
    }// toUPP
