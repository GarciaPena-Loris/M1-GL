...
public class RandomDonneesHotel {
    ...
    public static int randomPrix(int nombreEtoile, int nombreLits) {
        return switch (nombreEtoile) {
            case 1 -> new Random().nextInt(10) + 30 + (nombreLits * 10); // Prix entre 50 et 80 + 5€ par lit
            case 2 -> new Random().nextInt(20) + 55 + (nombreLits * 12); // Prix entre 55 et 85 + 5€ par lit
            case 3 -> new Random().nextInt(40) + 90 + (nombreLits * 15); // Prix entre 60 et 90 + 5€ par lit
            case 4 -> new Random().nextInt(80) + 130 + (nombreLits * 15); // Prix entre 65 et 95 + 5€ par lit
            case 5 -> new Random().nextInt(250) + 200 + (nombreLits * 20); // Prix entre 70 et 100 + 5€ par lit
            default ->
                    new Random().nextInt(50) + (nombreLits * (nombreEtoile * 5)) + 50 * nombreEtoile; // Prix entre 50 et 130 + 5€ par lit + 50€ par étoile  (prix entre 50 et 130 pour 1 étoile, entre 55 et 135 pour 2 étoiles, etc.)
        };
    }
    ...
    public static Adresse generateRandomAdresse() {
        ...
        return new Adresse(null, numero, rue, ville, pays, position);
    }
