 ...
 * 
 */
@WebServiceClient(name = "HotelServiceImplService", targetNamespace = "http://service.archi.m1/", wsdlLocation = "http://localhost:8080/hotelservice?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICEIMPLSERVICE_QNAME = new QName("http://service.archi.m1/", "HotelServiceImplService");
    ...
    public HotelService getHotelServiceImplPort() {
        return super.getPort(new QName("http://service.archi.m1/", "HotelServiceImplPort"), HotelService.class);
    }
    ...
    public HotelService getHotelServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.archi.m1/", "HotelServiceImplPort"), HotelService.class, features);
    }
