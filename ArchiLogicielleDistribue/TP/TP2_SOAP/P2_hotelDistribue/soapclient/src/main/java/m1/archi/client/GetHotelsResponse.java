 ...
 *       &lt;sequence>
 *         &lt;element name="return" type="{http://service.archi.m1/}hotel" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetHotelsResponse {
     ...
     * 
     */
    public List<Hotel> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Hotel>();
        }
        return this._return;
    }
