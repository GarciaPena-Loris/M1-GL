 ...
 * 
 */
@WebServiceClient(name = "HotelServiceReservationImplService", targetNamespace = "http://service.archi.m1/", wsdlLocation = "http://localhost:8080/hotelservice/H1699202486767/reservation?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HOTELSERVICERESERVATIONIMPLSERVICE_QNAME = new QName("http://service.archi.m1/", "HotelServiceReservationImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/hotelservice/H1699202486767/reservation?wsdl");
    ...
    public HotelServiceReservation getHotelServiceReservationImplPort() {
        return super.getPort(new QName("http://service.archi.m1/", "HotelServiceReservationImplPort"), HotelServiceReservation.class);
    }
    ...
    public HotelServiceReservation getHotelServiceReservationImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.archi.m1/", "HotelServiceReservationImplPort"), HotelServiceReservation.class, features);
    }
